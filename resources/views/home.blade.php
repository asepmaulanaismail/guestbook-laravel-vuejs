...
<meta name="description" content="Compare prices in many marketplace" />
<meta name="author" content="ptbsp.com" />
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
<title>Web Search Client - Web Crawler</title>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 xs-mb-10">
        <div class="topbar-call text-center text-md-left">
          <ul>
            <li><i class="fa fa-envelope-o theme-color"></i> info@ptbsp.com</li>
       ...
       <div class="col-lg-12 col-md-12"> 
        ...
        <div class="menu-bar">
         ...
         <li><a href="javascript:void(0)">Home <i class="fa fa-angle-down fa-indicator"></i></a>
                    ...
                    <div class="grid-row">
                        ...
                        <div class="grid-col-3">
                            <ul>
                              ...
                              <li><a href="index-bitcoin.html">Bitcoin <span class="badge badge-info">Trending</span> </a></li> 
            ...
            <li class="active"><a href="javascript:void(0)">Portfolio<i class="fa fa-angle-down fa-indicator"></i></a>
                <!-- drop down multilevel  -->
                <ul class="drop-down-multilevel left-side">
                    
                    <li class="active"><a href="#">portfolio classic <i class="ti-plus fa-indicator"></i></a>
                      <!-- drop down second level -->
                        <ul class="drop-down-multilevel left-side">
                            <li><a href="javascript:void(0)"> 1 column  <i class="ti-plus fa-indicator"></i></a>
                                ...
                                <ul class="drop-down-multilevel left-side">
                                    ...
                                    <li class="active"><a href="portfolio-classic-1-columns-left-sidebar.html">left sidebar</a></li>
...
<section class="page-title bg-overlay-black-60 parallax" data-jarallax='{"speed": 0.6}' style="background-image: url(images/cover.jpeg);">
  <div class="container">
    <div class="row"> 
      <div class="col-lg-12"> 
      <div class="page-title-name">
          <h1>Web Crawler</h1>
          <p>Compare Prices in Many Marketplace</p>
        </div>
     </div>
   </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-3">
          <div class="sidebar-widget">
            <h6 class="mb-20">Search</h6>
              <div class="widget-search">
                  <i id="search-product" class="fa fa-search"></i>
                  <input type="search" class="form-control" placeholder="Search...." />
                </div>
          </div>
          <div class="sidebar-widget">
             <h6 class="mt-40 mb-20">Price</h6>
             <div>
                <input class="form-control" name="min-price" type="number" placeholder="Minimum" style="margin-bottom: 10px;"/>
                <input class="form-control" name="max-price" type="number" placeholder="Maximum"/>
             </div>
          </div>
          <div class="sidebar-widget clearfix">
            <h6 class="mt-40 mb-20">Categories</h6>
            <ul class="widget-categories">
              <li><input type="checkbox"> Electronics</li>
              <li><input type="checkbox"> Automotives</li>
        ...
        <div class="sidebar-widget clearfix">
          <h6 class="mt-40 mb-20">Locations</h6>
          <ul class="widget-categories">
            <li><input type="checkbox"> Bandung</li>
            <li><input type="checkbox"> Jakarta</li>
            <li><input type="checkbox"> Surabaya</li>
            <li><input type="checkbox"> Yogyakarta</li>
            <li><input type="checkbox"> Cimahi</li>
              <li><a href="#">See more</a></li>
          </ul>
      </div>
   </div>
<!-- ============================= -->
      <div class="col-lg-9 text-center">
         <div class="isotope-filters">
            ...
            <button data-filter=".bukalapak">bukalapak</button>
            <button data-filter=".tokopedia">tokopedia</button>
            <button data-filter=".shopee">shopee</button>
            <button data-filter=".blibli">blibli</button>
          </div>
            <div id="loading"><center>Loading...</center></div>
            <div id="suggest" style="display: none; font-size: 18px; text-align: left;"></div>
            <div id="search_result" class="isotope columns-1 no-title">
           </div>
       </div>
     </div>
    </div> 
...
<script>
    ...
    function search(q){
        ...
        $.ajax({
            url: 'http://web-search-client.loc:9200/20180312/_search',
            type: 'POST',
            ...
            success: function(data){
                ...
                for(var i in data.hits.hits){
                    ...
                    var name = obj._source.name; 
                    if (name.length > 45)
                        name = name.substr(0,45) + "...";
                    str += "<div class='grid-item row' data-category='tokopedia' style='padding: 0px; margin-bottom: 10px;'>";
                    str += "    <div class='col-md-3 portfolio-item'>";
                    str += "        <img src='" + obj._source.image + "' alt='' style='height: 100%;'>";
                    str += "    </div>";
                    str += "    <div class='col-md-9' style='padding: 10px 50x;'>";
                    str += "        <div class='portfolio-overlay' style='text-align: left;'>";
                    str += "            <h4 class='text-black'><a href='#' title='" + obj._source.name + "'>" + name + "</a> </h4>";
                    str += "            <p class='text-black' style='font-size: 25px; margin: 0px;'>" + obj._source.price + "</p>";
                    str += "            <p style='font-size: 17px;'><i class='fa fa-home'></i> " + obj._source.merchant + " &nbsp;&nbsp;<i class='fa fa-globe'></i> " + obj._source.city + "</p>";
                    str += "            <a class='button x-small' href='" + obj._source.url + "' target='_blank'>Lihat di Tokopedia</a>";
                    str += "        </div>";
                    str += "    </div>";
                    str += "  </div>";
                }
                ...
                var typo = false;
                if (data.suggest){
                    if (data.suggest.simple_phrase.length > 0){
                        for(var i in data.suggest.simple_phrase)
                        {
                            if (data.suggest.simple_phrase[i].options.length > 0){
                                typo = true;
                                suggest += data.suggest.simple_phrase[i].options[0].text + " ";
                            }else{
                                suggest += data.suggest.simple_phrase[i].text + " ";
                            }
                        }
                    }
                }
                ...
                if (typo && !typo_run){
                    $("#suggest").html("<p class='typo'>Do you mean <span onclick='javascript: typo(\"" + suggest + "\")'><b><em>" + suggest + "</em></b></span></p>");
                    $("#suggest").show();
                }else{
                    $("#suggest").hide();
                }
